...
%    disp(['L1= ',num2str(L1),' L2= ',num2str(L2)])
    ...
    PE12 = 1 - PF - PE1 - PE2 ;
%    disp(['PE1= ',num2str(PE1)])
%    disp(['PE2= ',num2str(PE2)])
%    disp(['PE12= ',num2str(PE12)])
%    disp(['PF= ',num2str(PF)])
...
%     disp([W1,W2])
%     disp(['lambda1= ',num2str(Lambda*p*(PE1 + PE12)),' lambda2=',num2str((Lambda*(1-p)*(PE2 + PE12))) ])
    Tmp1 = p*(PE1 + PE12);
    Tmp2 = (1-p)*(PE2 + PE12);
...
%     WaitingTime=W_Test;
%     WaitingTime = W_Test-(p/mu1+(1-p)/mu2);
%     disp(['MeanWaitingTime=',num2str(WaitingTime)])
    WaitingTime = W_Test-(final_p/mu1+(1-final_p)/mu2);
%     disp(['MeanWaitingTime(new)=',num2str(WaitingTime)])
    return