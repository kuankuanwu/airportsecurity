...
%     iseed =  [271627303,1917625837,3049361867,44444444];
   ...
   max_securitylevel = d1*CalcR1(tau,theta) + d2*CalcR2(tau,theta);
   Cost = c1*S1 + c2*S2 + Beta1*CalcP(tau,theta) + Beta2*(1-CalcP(tau,theta)); 
   [MeanWaitingTimeSim,SE]=Simulation_AirportModel(tau,S1,S2,iseed,Num_Warmup,Num_Simulation,20);
   test=[test;[S1,S2,tau,max_securitylevel,MeanWaitingTimeSim-Epsilon,SE,MeanWaitingTime-Epsilon,Num_Simulation,iseed]];
