...
function iseed = arrive_non_selectee(iseed,Num_Warmup)
    ...
    if IdleServerIdx == 0
        ...
        [ProcessTime_Dummy,iseed(4)] = rexpo(1/mu2,iseed(4));
...
function iseed = arrive_selectee(iseed,Num_Warmup)
    ...
    if QueueNum_SelecteeLane == 0
        ...
        if IdleServerIdx == 0
            ...
            [ProcessTime_Dummy,iseed(3)] = rexpo(1/mu1,iseed(3));
            [ProcessTime,iseed(4)] = rexpo(1/mu2,iseed(4));
            %ProcessTime = 1/mu2;
...
function iseed = depart_non_selectee(iseed,Next_Departure_ServerIdx,Num_Warmup)
    ...
    if QueueNum_NonSelecteeLane == 0
        ...
        [ProcessTime_Dummy,iseed(4)] = rexpo(1/mu1,iseed(4));
        [ProcessTime,iseed(3)] = rexpo(1/mu1,iseed(3));
        %ProcessTime = 1/mu1;
...
function iseed = depart_selectee(iseed,Next_Departure_ServerIdx,Num_Warmup)
    ...
    if QueueNum_SelecteeLane == 0
        ...
        [ProcessTime_Dummy,iseed(3)] = rexpo(1/mu2,iseed(3));
        [ProcessTime,iseed(4)] = rexpo(1/mu2,iseed(4));
        %ProcessTime = 1/mu2;
