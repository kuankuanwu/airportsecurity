...
FileName = ['Case33_N200_' num2str(i) '_c1_' ,num2str(c1),'_c2_',num2str(c2),'_beta1_',num2str(Beta1),'_beta2_',num2str(Beta2),'_Budget_',num2str(Budget),'_epsilon_',num2str(Epsilon),...
