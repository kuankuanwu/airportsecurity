...
for trial = 1:1
log_test_name='Debug_log_SimpleBisection_Case13_RandomInitial.txt';
log_test=fopen(log_test_name, 'w'); 
problemname      = 'AirportSecurity';
problemparam     = [0 2 4 1 1000 0.001 0.005 0];
...
solverparam      = [1 100 4 3.5 0.4 8 10 .002 0.1 1 m0 geomc ...
                    500000 1.01 0.05 0.65 1 0]; 
...
logfilename      = strcat('cgRSPLINE-on-AirportSecurity_SimpleBisection_Case13_Linear_',int2str(solverseed));  
                             % log file base name 
