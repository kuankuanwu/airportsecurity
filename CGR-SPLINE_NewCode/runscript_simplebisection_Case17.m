...
global trial
for trial = 2:2
log_test_name='Debug_log_SimpleBisection_Case17_RandomInitial.txt';
...
logfilename      = strcat('cgRSPLINE-on-AirportSecurity_SimpleBisection_Case17_Linear_',int2str(solverseed));  
                             % log file base name 
