...
xlswrite('R&S_Case5_best_SE.xls',trial_best_SE);
xlswrite('R&S_Case5_best_test.xls',trial_best_test);
xlswrite('R&S_Case5_TotalCost.xls',trial_cost);
xlswrite(strcat('R&S_Case5_average_tau_Trial',int2str(t),'.xls'),sencond_tauavma);
xlswrite(strcat('R&S_Case5_SE_Trial',int2str(t),'.xls'),sencond_sema);
xlswrite(strcat('R&S_Case5_test_Trial',int2str(t),'.xls'),second_test);
end
