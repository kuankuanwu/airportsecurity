...
log_test_name='Debug_log_SimpleBisection.txt';
...
x0               = [0 0; ceil(Budget/c1) ceil(Budget/c2)]; 
                             % [min; max]
...
logfilename      = 'cgRSPLINE-on-AirportSecurity_SimpleBisection';  
                             % log file base name 
budget           = 1000000;    % 'numfinalsols'=1
