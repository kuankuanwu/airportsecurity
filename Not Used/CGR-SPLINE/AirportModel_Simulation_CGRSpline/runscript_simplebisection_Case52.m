...
log_test_name='Debug_log_SimpleBisection_Case52_Linear.txt';
log_test=fopen(log_test_name, 'w'); 
problemname      = 'AirportSecurity';
problemparam     = [0 2 4 2 2000 0.001 0.8];
...
solverseedparam  = [1, 0];   % nsolvseeds = 1
                             ...
                             % requires actual seeds values
solverseed       = 1497547;    %48906,10000,20000
logfilename      = 'cgRSPLINE-on-AirportSecurity_SimpleBisection_Case52_Linear_1497547';  
                             % log file base name 
budget           = 30000000;    % 'numfinalsols'=1
