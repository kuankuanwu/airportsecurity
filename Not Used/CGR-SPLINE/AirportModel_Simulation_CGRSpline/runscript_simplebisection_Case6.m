...
log_test_name='Debug_log_SimpleBisection_Case6_RandomInitial.txt';
log_test=fopen(log_test_name, 'w'); 
problemname      = 'AirportSecurity';
problemparam     = [0 2 4 2 200 0.001 0.1];
...
solverseedparam  = [1, 0];   % nsolvseeds = 1
                             ...
                             % requires actual seeds values
solverseed       = 50000;    %48906,10000,20000
logfilename      = 'cgRSPLINE-on-AirportSecurity_SimpleBisection_Case6_RandomInitial';  
                             % log file base name 
