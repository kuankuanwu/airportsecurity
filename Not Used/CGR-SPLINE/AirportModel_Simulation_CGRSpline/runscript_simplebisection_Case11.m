...
for trial = 3:3
log_test_name='Debug_log_SimpleBisection_Case11_RandomInitial.txt';
log_test=fopen(log_test_name, 'w'); 
problemname      = 'AirportSecurity';
problemparam     = [0 2 4 1 2000 0.001 0.05];
...
solverparam      = [1 40 1000 3.5 0.4 8 10 .002 0.1 1 m0 geomc ...
                    500000 1.1 0.95 0.65]; 
...
logfilename      = strcat('cgRSPLINE-on-AirportSecurity_SimpleBisection_Case11_Linear_',int2str(solverseed));  
                             % log file base name 
budget           = 50000000;    % 'numfinalsols'=1
